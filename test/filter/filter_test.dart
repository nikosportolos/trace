...
void main() {
  ...
  final LogEntry noneEntry = LogEntry(
    level: LogLevel.none,
    timestamp: now,
    message: message,
  );
  final LogEntry verboseEntry = LogEntry(
    level: LogLevel.verbose,
    timestamp: now,
    message: message,
  );
  final LogEntry debugEntry = LogEntry(
    level: LogLevel.debug,
    timestamp: now,
    message: message,
  );
  final LogEntry infoEntry = LogEntry(
    level: LogLevel.info,
    timestamp: now,
    message: message,
  );
  final LogEntry successEntry = LogEntry(
    level: LogLevel.success,
    timestamp: now,
    message: message,
  );
  final LogEntry warningEntry = LogEntry(
    level: LogLevel.warning,
    timestamp: now,
    message: message,
  );
  final LogEntry errorEntry = LogEntry(
    level: LogLevel.error,
    timestamp: now,
    message: message,
  );
  final LogEntry fatalEntry = LogEntry(
  ...
  group('Filters', () {
    test('DefaultLogFilter', () {
      final LogFilter filter = DefaultLogFilter(
        LogLevel.info,
        debugOnly: false,
      );
